...
var connectionString = builder.Configuration.GetConnectionString("SistemaAPIWeb");

builder.Services.AddDbContext<AppDBContextSistema>(options =>
...
// Evita redirect para /Account/Login em APIs
